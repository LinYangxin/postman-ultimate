...
public class PostmanHelper {
    ...
    public static final int REQUEST_CODE_SET_DATA = 1;
    ...
    public static void setSystemBarTintManager(SystemBarTintManagerHelper systemBarTintManager, Activity activity) {
        Log.i("PostmanHelper", "通知栏改色");
        systemBarTintManager = new SystemBarTintManagerHelper(activity);
    }
}
