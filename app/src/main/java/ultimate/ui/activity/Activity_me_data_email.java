 ...
 */
public class Activity_me_data_email extends Activity {
        ...
        tittleManager.setRightTitleListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(new_email) || new_email.isEmpty() || !isEmailValid(new_email)) {
                    Toast.makeText(Activity_me_data_email.this, "不能为空或格式有误!", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    user.getMyUser().saveInBackground(new SaveCallback() {
                        ...
                        public void done(AVException e) {
                            if (e == null) {
                                AlertDialog.Builder ab = new AlertDialog.Builder(Activity_me_data_email.this);
                                ab.setTitle("提示").setMessage("资料补充完成，请查收邮箱，完成邮箱核验").setPositiveButton("知道了", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        user.setEmail(new_email);
                                        Activity_me_data_email.this.setResult(REQUEST_EMAIL);
                                        Activity_me_data_email.this.finish();
                                    }
                                }).show();

                            } else {
                                Toast.makeText(Activity_me_data_email.this, "失败!请检查网络", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
    ...
    public void onBackPressed() {
        ...
        Activity_me_data_email.this.setResult(NOTHING, intent);
        Activity_me_data_email.this.finish();
    }
