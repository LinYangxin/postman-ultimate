 ...
 */
public class Activity_me_data_team extends Activity {
  ...
  //  private AVUser myUser;
        ...
        tittleManager.setRightTitleListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(new_team)||new_team.isEmpty()){
                    Toast.makeText(Activity_me_data_team.this,"不能为空!",Toast.LENGTH_SHORT).show();
                }
                else{
                   user.getMyUser().put("team",new_team);
                    user.getMyUser().saveInBackground(new SaveCallback() {
                        ...
                        public void done(AVException e) {
                            if(e==null){
                                Toast.makeText(Activity_me_data_team.this,"保存成功!",Toast.LENGTH_SHORT).show();
                               user.setTeam(new_team);
                                Activity_me_data_team.this.setResult(REQUEST_TEAM);
                                Activity_me_data_team.this.finish();
                            }
                            else{
                                Toast.makeText(Activity_me_data_team.this,"失败!请检查网络",Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
    ...
    public void onBackPressed(){
        Activity_me_data_team.this.setResult(NOTHING);
        Activity_me_data_team.this.finish();
    }
}
